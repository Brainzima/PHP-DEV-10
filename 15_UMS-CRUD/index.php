...
<div class="row mt-3">
    ...
    <div class="col-md-3">
        ...
        <div class="card shadow-sm border-0 h-100 bg-light-subtle">
            <div class="card-body p-3">
                ...
                <div class="d-flex align-items-center mb-2">
                    ...
                    <div>
                        ...
                        <span class="badge bg-success badge-sm"><?php echo $data['status'] ?></span>
                    </div>
                </div>
                ...
                <div class="row g-2 mb-2 small">
                    <div class="col-6">
                        ...
                        <span class="badge bg-primary px-2 py-1"><?php echo $data['qualification'] ?></span>
                    </div>
                    <div class="col-6">
                        <small class="text-muted d-block mb-1"><i class="fas fa-briefcase me-1"></i>Preference</small>
                        <span class="badge bg-info px-2 py-1"><?php echo $data['job_pf'] ?></span>
                    </div>
                </div>
